...
def get(vk_session, id_group, vk):
    try:
        ...
        max_num = vk.photos.get(owner_id=id_group, album_id='201818209', count=0)['count']
        ...
        pictures = vk.photos.get(owner_id=str(id_group), album_id='201818209', count=3, offset=num)['items']
        buf = []
